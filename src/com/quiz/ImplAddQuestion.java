...
public class ImplAddQuestion implements AddQuestion{
	/*getAddQuestion()-method is used to verify admin details*/
	/*Author Name-Irfan*/
	@Override
	...
	/*addNewQuestion()-method is used to add Question in Database if admin credentials are verified*/	
	/*Author Name-Irfan*/
	private static void addNewQuestion() throws Exception {
		System.out.println("-----Add Questions Here (Admin Only)-----\n\n");
