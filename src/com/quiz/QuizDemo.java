...
public class QuizDemo {
	/*taken scanner as static to use in all methods without creating object*/
...
/*Main Program start here, which contains UI */
	/*Author Name-Sarika*/
...
/*Below code allows user to perform above operations repeatatively*/
